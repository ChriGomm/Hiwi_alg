...
@with_kw struct NumericalParameters
    ...
    nk::Int = 120      # ngrid illiquid assets (capital) (10 is the coarse grid used initially in finding the StE)
    nm::Int = 120      # ngrid liquid assets (bonds) (10 is the coarse grid used initially in finding the StE)
