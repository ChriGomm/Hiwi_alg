...
@with_kw struct NumericalParameters
    ...
    nk::Int = 250       # ngrid illiquid assets (capital) (10 is the coarse grid used initially in finding the StE)
    nm::Int = 250       # ngrid liquid assets (bonds) (10 is the coarse grid used initially in finding the StE)
    ...
    kmax::Float64 = 2000.0    # gridmax capital
